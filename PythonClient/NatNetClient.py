    ...
    def __process_message(self, data: bytes, print_level=0):
        ...
        if show_nat_net_version:
            trace("NatNetVersion ", str(self.__nat_net_requested_version[0]), " ",
                  str(self.__nat_net_requested_version[1]), " ", str(self.__nat_net_requested_version[2]), " ",
        ...
        if message_id == self.NAT_FRAMEOFDATA:
            ...
            if packet_size == 4:
                ...
                if (show_remainder):
                    trace("Command response:", message.decode('utf-8'), " separator:", separator, " remainder:",
                          remainder)
                else:
